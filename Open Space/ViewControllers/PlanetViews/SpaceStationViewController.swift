...
class SpaceStationViewController: UIViewController {
    ...
    @IBAction func changeView() {
        let pictures = ["eye-of-the-storm-image-from-outer-space-71116.jpg", "14648179676_db2001e0fa_o.jpg", "24609260915_a840b027e5_o.jpg",
    ...
    @IBAction func takeOffAction() {
        ...
        Utils.shared.saveLocation(location: "nearISS", usesEnergy: "0")
